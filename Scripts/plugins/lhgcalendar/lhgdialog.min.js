 ...
 */
c=function(n){var u=n.target,t=r.focus,i=n.keyCode;t&&t.config.esc&&t.config.cancel!==!1&&i===27&&t._click(t.config.cancelVal)};_$doc.bind("keydown",c);
/*!
 * 框架页面卸载前关闭所有穿越的对话框
 * 同时移除拖动层和遮罩层
 */
o!=t&&n(t).bind("unload",function(){var t=r.list;for(var i in t)t[i]&&t[i].close();e&&e.DOM.wrap.remove();_$doc.unbind("keydown",c);n("#ldg_lockmask",u)[0]&&n("#ldg_lockmask",u).remove();n("#ldg_dragmask",u)[0]&&n("#ldg_dragmask",u).remove()});
/*! lhgdialog 的全局默认配置 */
r.setting={content:'<div class="ui_loading"><span>loading...<\/span><\/div>',title:"提示",button:null,ok:null,cancel:null,init:null,close:null,okVal:"确定",cancelVal:"取消",skin:"",esc:!0,show:!0,width:"auto",height:"auto",icon:null,path:w,lock:!1,focus:!0,parent:null,padding:"10px",fixed:!1,left:"50%",top:"38.2%",max:!0,min:!0,zIndex:1976,resize:!0,drag:!0,cache:!0,data:null,extendDrag:!1};
/*!
 *------------------------------------------------
 * 对话框模块-拖拽支持（可选外置模块）
 *------------------------------------------------
 */
v="setCapture"in k;y="onlosecapture"in k;r.dragEvent={onstart:s,start:function(n){var t=r.dragEvent;_$doc.bind("mousemove",t.move).bind("mouseup",t.end);t._sClientX=n.clientX;t._sClientY=n.clientY;t.onstart(n.clientX,n.clientY);return!1},onmove:s,move:function(n){var t=r.dragEvent;t.onmove(n.clientX-t._sClientX,n.clientY-t._sClientY);return!1},onend:s,end:function(n){var t=r.dragEvent;_$doc.unbind("mousemove",t.move).unbind("mouseup",t.end);t.onend(n.clientX,n.clientY);return!1}};g=function(t){var l,b,k,d,g,p,s=r.focus,h=s.config,c=s.DOM,e=c.wrap[0],a=c.title,w=c.main[0],i=r.dragEvent,nt="getSelection"in o?function(){o.getSelection().removeAllRanges()}:function(){try{u.selection.empty()}catch(n){}};i.onstart=function(){p?(b=w.offsetWidth,k=w.offsetHeight):(d=e.offsetLeft,g=e.offsetTop);_$doc.bind("dblclick",i.end);!f&&y?a.bind("losecapture",i.end):_$top.bind("blur",i.end);v&&a[0].setCapture();c.border.addClass("ui_state_drag");s.focus()};i.onmove=function(t,i){if(p){var u=e.style,r=w.style,f=t+b,o=i+k;u.width="auto";h.width=r.width=Math.max(0,f)+"px";u.width=e.offsetWidth+"px";h.height=r.height=Math.max(0,o)+"px";s._load&&n(s._load).css({width:r.width,height:r.height})}else{var r=e.style,c=t+d,a=i+g;h.left=Math.max(l.minX,Math.min(l.maxX,c));h.top=Math.max(l.minY,Math.min(l.maxY,a));r.left=h.left+"px";r.top=h.top+"px"}nt()};i.onend=function(){_$doc.unbind("dblclick",i.end);!f&&y?a.unbind("losecapture",i.end):_$top.unbind("blur",i.end);v&&a[0].releaseCapture();f&&s._autoPositionType();c.border.removeClass("ui_state_drag")};p=t.target===c.rb[0]?!0:!1;l=function(n){var r=e.offsetWidth,u=a[0].offsetHeight||20,f=_$top.width(),o=_$top.height(),t=n?0:_$top.scrollLeft(),i=n?0:_$top.scrollTop();return maxX=f-r+t,maxY=o-u+i,{minX:t,minY:i,maxX:maxX,maxY:maxY}}(e.style.position==="fixed");i.start(t)};
/*! 
 * 页面DOM加载完成执行的代码
 */
n(function(){setTimeout(function(){h||r({left:"-9999em",time:9,fixed:!1,lock:!1,focus:!1})},150);r.setting.extendDrag&&function(n){var i=u.createElement("div"),t=i.style,e=f?"absolute":"fixed";i.id="ldg_dragmask";t.cssText="display:none;position:"+e+";left:0;top:0;width:100%;height:100%;cursor:move;filter:alpha(opacity=0);opacity:0;background:#FFF;pointer-events:none;";u.body.appendChild(i);n._start=n.start;n._end=n.end;n.start=function(){var u=r.focus,i=u.DOM.main[0],f=u.iframe;n._start.apply(this,arguments);t.display="block";t.zIndex=r.setting.zIndex+3;e==="absolute"&&(t.width=_$top.width()+"px",t.height=_$top.height()+"px",t.left=_$doc.scrollLeft()+"px",t.top=_$doc.scrollTop()+"px");f&&i.offsetWidth*i.offsetHeight>307200&&(i.style.visibility="hidden")};n.end=function(){var i=r.focus;n._end.apply(this,arguments);t.display="none";i&&(i.DOM.main[0].style.visibility="visible")}}(r.dragEvent)});
/*! 使用jQ方式调用窗口 */
n.fn.dialog=function(){var n=arguments;return this.bind("click",function(){return r.apply(this,n),!1}),this};t.lhgdialog=n.dialog=r})(this.jQuery||this.lhgcore,this);
/*!
 *------------------------------------------------
 * 对话框其它功能扩展模块（可选外置模块）
 *------------------------------------------------
 */
(function(n,t){var i=function(){return t.setting.zIndex};t.alert=function(n,r,u){return t({title:"提示",id:"Alert",zIndex:i(),icon:"alert.gif",fixed:!0,lock:!0,content:n,ok:!0,resize:!1,close:r,parent:u||null})};t.confirm=function(n,r,u,f){return t({title:"确认",id:"confirm.gif",zIndex:i(),icon:"confirm.gif",fixed:!0,lock:!0,content:n,resize:!1,parent:f||null,ok:function(n){return r.call(this,n)},cancel:function(n){return u&&u.call(this,n)}})};t.prompt=function(n,r,u,f){u=u||"";var e;return t({title:"提问",id:"Prompt",zIndex:i(),icon:"prompt.gif",fixed:!0,lock:!0,parent:f||null,content:['<div style="margin-bottom:5px;font-size:12px">',n,"<\/div>","<div>",'<input value="',u,'" style="width:18em;padding:6px 4px" />',"<\/div>"].join(""),init:function(){e=this.DOM.content[0].getElementsByTagName("input")[0];e.select();e.focus()},ok:function(n){return r&&r.call(this,e.value,n)},cancel:!0})};t.tips=function(n,r,u,f){var e=u?function(){this.DOM.icon[0].innerHTML='<img src="'+this.config.path+"skins/icons/"+u+'" class="ui_icon_bg"/>';this.DOM.icon[0].style.display="";f&&(this.config.close=f)}:function(){this.DOM.icon[0].style.display="none";f&&(this.config.close=f)};return t({id:"Tips",zIndex:i(),title:!1,cancel:!1,fixed:!0,lock:!1,resize:!1}).content(n).time(r||1.5,e)}})(this.jQuery||this.lhgcore,this.lhgdialog);
//# sourceMappingURL=lhgdialog.min.js.map
